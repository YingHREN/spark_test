...
# TODO: Replace <FILL IN> with appropriate code
capitalLambdaRDD = wordsRDD.map(lambda word : capitalize(word))
...
def removePunctuation(text):
    ...
    """
    removed = re.sub(r'[^a-zA-Z0-9 ]','', text.lower())
...
# TODO: Replace <FILL IN> with appropriate code
top10WordsAndCounts = wordCount(shakespeareWordsRDD).takeOrdered(10, lambda (word, count) : -count)
